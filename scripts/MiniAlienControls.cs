...
public class MiniAlienControls : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        PlayerTarget = GameObject.FindGameObjectWithTag("check8");    //finding target using tag(i.e. Player)
    ...
    void Update()
    {
        ...
        {
            SpawnID = 0;
            PlayerTarget = GameObject.FindGameObjectWithTag("check1");
            StartCoroutine(spawnWait());
        }
        if (SpawnID == 2)
        {
            SpawnID = 0;
            PlayerTarget = GameObject.FindGameObjectWithTag("check2");
            StartCoroutine(spawnWait());
        }
        if (SpawnID == 3)
        {
            SpawnID = 0;
            PlayerTarget = GameObject.FindGameObjectWithTag("check3");
            StartCoroutine(spawnWait());
        }
        if (SpawnID == 4)
        {
            SpawnID = 0;
            PlayerTarget = GameObject.FindGameObjectWithTag("check4");
            StartCoroutine(spawnWait());
        }
        if (SpawnID == 5)
        {
            SpawnID = 0;
            PlayerTarget = GameObject.FindGameObjectWithTag("check5");
            StartCoroutine(spawnWait());
        }
        if (SpawnID == 6)
        {
            SpawnID = 0;
            PlayerTarget = GameObject.FindGameObjectWithTag("check6");
            StartCoroutine(spawnWait());
        }
        if (SpawnID == 7)
        {
            SpawnID = 0;
            PlayerTarget = GameObject.FindGameObjectWithTag("check7");
            StartCoroutine(spawnWait());
        }
        if (SpawnID == 8)
        {
            SpawnID = 0;
            PlayerTarget = GameObject.FindGameObjectWithTag("check8");
            StartCoroutine(spawnWait());
        }
        if (SpawnID == 9)
        {
            SpawnID = 0;
            PlayerTarget = GameObject.FindGameObjectWithTag("check9");
            StartCoroutine(spawnWait());
        }
        if (SpawnID == 10)
        {
            SpawnID = 0;
            PlayerTarget = GameObject.FindGameObjectWithTag("check10");
            StartCoroutine(spawnWait());
        }
